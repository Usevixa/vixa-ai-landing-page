    ...
    () => {
      ...
      if (reduced) {
        requestAnimationFrame(() => {
          section.current
            ?.querySelectorAll<HTMLElement>(".screen-rect")
            .forEach((root) => {
          ...
          scrollTrigger: {
            ...
            onUpdate: (self) => {
              const p = gsap.utils.clamp(
                0,
                1,
                (self.progress - THREAD_START) / THREAD_SPAN,
              );
      ...
      mm.add("(max-width: 1023.98px)", () => {
        const frame = section.current!.querySelector<HTMLElement>(
          ".phone-frame-mobile",
        )!;
        ...
        const tl = gsap.timeline({
          scrollTrigger: {
            ...
            invalidateOnRefresh: true,
            onUpdate: (self) =>
              applyDiscreteStates(threadRoot, self.progress, heroThread),
          },
        });
        tl.set({}, {}, 1);
        const threadTl = buildThreadTimeline(threadRoot, heroThread);
          ...
          <div className="content-col relative w-full">
            <div className="split-grid">
              ...
              <div className="split-copy" data-reveal-group>
                ...
                >
                  Send money on <span className="text-vx-olive">WhatsApp</span>,
                  instantly across <span className="text-vx-olive">Africa</span>
                  .
                </h1>
                <p
                  data-reveal
                  className="text-body-lg mt-6 max-w-[48ch] text-vx-ash"
                >
                  Send money like you send a message. Buy, sell, swap, or move
                  crypto. No apps. No long steps. Just send a message, confirm
                  with your PIN, and your money moves.
                </p>
                <div
                  data-reveal
              ...
              <div className="split-visual relative">
                ...
                <div
                  ...
                  style={{
                    aspectRatio: `${screenRect.imgW} / ${screenRect.imgH}`,
                ...
                >
                  ...
                  <div
                    className="screen-rect absolute overflow-hidden"
                    style={rectStyle}
                  >
                ...
                <div className="phone-frame-mobile mx-auto w-full max-w-[330px] lg:hidden">
                  <div
                    ...
                    style={{
                      ...
                      boxShadow:
                        "0 2px 4px rgba(15,25,18,0.14), 0 30px 60px -24px rgba(15,25,18,0.4)",
                    }}
                  >
                    <div
                ...
                <div className="hero-float hero-float-rate absolute left-[-2%] top-[24%] z-20 hidden items-center gap-3 rounded-[16px] border border-vx-slate bg-white px-4 py-3 shadow-[0_10px_30px_-12px_rgba(15,25,18,0.25)] lg:flex">
                  ...
                  />
                  <div>
                    <p className="text-[15px] font-semibold leading-5 text-vx-bone">
                      ₦1,400.11
                    </p>
                    <p className="text-mono-meta mt-0.5 text-vx-ash">
                      Buy rate · USDT
                    </p>
                  </div>
                </div>
                <div className="hero-float hero-float-done absolute right-[-3%] top-[62%] z-20 hidden items-center gap-3 rounded-[16px] border border-vx-slate bg-white px-4 py-3 shadow-[0_10px_30px_-12px_rgba(15,25,18,0.25)] lg:flex">
                  <span
                    className="grid h-[34px] w-[34px] place-items-center rounded-full bg-vx-olive/12 text-vx-olive"
                    aria-hidden="true"
                  >
                    <svg
                      viewBox="0 0 16 16"
